...
{
    public sealed class CillyRoomBriefingController : MonoBehaviour
    {
        ...
        public void Show(CillyRoomLevelDefinition level, Sprite backgroundSprite, Color fallbackColor, UnityAction onContinue)
        {
            if (root != null)
            {
                root.SetActive(true);
