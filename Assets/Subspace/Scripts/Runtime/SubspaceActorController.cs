...
namespace Subspace
{
    public sealed class SubspaceActorController : MonoBehaviour
    {
        ...
        public void Configure(Image image, SpriteRenderer renderer, Rigidbody2D rigidbody2D, Animator actorAnimator = null, SubspaceSpineActorView actorSpineView = null)
        {
            uiImage = image;
        ...
        private void Awake()
        {
            ...
            if (spineView == null)
            {
                spineView = GetComponentInChildren<SubspaceSpineActorView>(true);
            }
        }
        ...
        public void ApplySpineLevel(SubspaceLevelDefinition level)
        {
        ...
        private void EnsureSpineView()
        {
            ...
            var spineObject = new GameObject("Enemy Spine Graphic", typeof(RectTransform), typeof(CanvasRenderer), typeof(SubspaceSpineActorView));
            ...
            spineView = spineObject.GetComponent<SubspaceSpineActorView>();
        ...
        private void SetFallbackGraphicsVisible(bool visible)
        {
            ...
            {
                if (graphic.GetComponentInParent<SubspaceSpineActorView>() != null)
                {
                    continue;
                }
